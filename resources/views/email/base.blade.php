...
<body bgcolor="#E1E1E1" leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" width="600px">
                                            ...
                                            <tr>
                                                <td valign="top" width="500" class="flexibleContainerCell">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td
                                                            " valign="top" class="flexibleContainerBox">
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                   style="max-width: 100%;">
                                                                <tr>
                                                            ...
                                                            <td valign="top" bgcolor="#E1E1E1">
                                                                ...
                                                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                    <div>
                                                                        @section('footer')
                                                                        @show
                                                                        <small><em>This in a automatic email sent from thyart, please do not reply.</em>
                                                                        </small>
                                                                    </div>
                                                                </div>
                                                            </td>
